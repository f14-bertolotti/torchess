...
__device__ unsigned char queenside_castle(
    ...
    boards[env][rook_target] = is_queenside_castle * is_queenside_ok ? PLAYER_ROOK : boards[env][rook_target];
    boards[env][king_target] = is_queenside_castle * is_queenside_ok ? PLAYER_KING : boards[env][king_target];
    boards[env][king_source] = is_queenside_castle * is_queenside_ok ? EMPTY       : boards[env][king_source];
    boards[env][rook_side]   = is_queenside_castle * is_queenside_ok ? EMPTY       : boards[env][rook_side];
    boards[env][rook_source] = is_queenside_castle * is_queenside_ok ? EMPTY       : boards[env][rook_source];
...
__global__ void step_kernel(
    ...
    const unsigned char  kingside_castling_result =  kingside_castling(env, players, boards, actions);
    const unsigned char queenside_castling_result = queenside_castling(env, players, boards, actions);
