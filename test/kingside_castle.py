...
def move(stringboard,turn,rights,move):
    ...
    torchaction = torch.tensor([0,0,0,0,1], dtype=torch.int).unsqueeze(1)
    torch_err = kingside_castling(torchboard, torchaction.to("cuda:0"), torchplayers.to("cuda:0")).item()
